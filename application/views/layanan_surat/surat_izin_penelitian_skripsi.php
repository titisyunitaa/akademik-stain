    ...
    <div class="container my-1">
        <header class="page-header text-center">
            <h1>Pengajuan Surat Izin Penelitian Skripsi</h1>
            <p>
                Surat ini diajukan oleh mahasiswa untuk memperoleh izin dari kampus dalam rangka pelaksanaan penelitian skripsi di instansi atau lembaga terkait.
            </p>
        </header>
            ...
            <div class="col-lg-8">
                ...
                <div class="container py-2">
                    <div class="form-container">
                        <h3 class="form-title mb-4">Form Pengajuan Surat Izin Penelitian Skripsi</h3>
...
<?php endif; ?>
                        ...
                        <?php endif; ?>
                        <form action="<?= base_url('layanan_surat/simpan_pengajuan_surat_izin_penelitian_skripsi') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="judul_skripsi" class="form-label label-bold">Judul Skripsi</label>
                                <input type="text" class="form-control" id="judul_skripsi" name="judul_skripsi" placeholder="Contoh: Melengkapi berkas beasiswa" value="<?= set_value('judul_skripsi', $this->session->flashdata('old_input')['judul_skripsi'] ?? ''); ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label label-bold">Kartu Rencana Studi (KRS)</label>
                                <input type="hidden" name="nama_dokumen[]" value="Kartu Rencana Studi (KRS)">
                                <input type="file" class="form-control" name="dokumen[]" accept=".pdf,.jpg,.jpeg,.png" required>
                            </div>

                             <div class="mb-3">
                                <label class="form-label label-bold">SK Penetapan Pembimbing Skripsi</label>
                                <input type="hidden" name="nama_dokumen[]" value="SK Penetapan Pembimbing Skripsi">
                                <input type="file" class="form-control" name="dokumen[]" accept=".pdf,.jpg,.jpeg,.png" required>
                            </div>
                        ...
                        <ul class="list-group list-group-flush">
                                                        <li class="list-group-item d-flex flex-column gap-2">
                                                            <div class="d-flex align-items-center gap-3">
                                                                ...
                                                                <span>Mengunduh formulir permohonan surat izin penelitian skripsi.</span>
                                                            </div>
                                                            <a href="<?php echo base_url('uploads/dokumen/Form-Permohonan-Surat-Izin-Penelitian-Skripsi.docx') ?>" class="btn btn-gradient btn-sm mt-2 align-self-start" target="_blank">
                                                                <i class="bi bi-download me-1"></i> Download Form Permohonan surat izin penelitian skripsi
                                                            </a>
                                                        </li>
                            ...
                            <li class="list-group-item d-flex gap-3"><i class="bi bi-check-circle-fill text-success"></i> Mengisi formulir dengan lengkap dan meminta persetujuan Ketua Program Studi dan Pembimbing I.</li>
                            <li class="list-group-item d-flex gap-3"><i class="bi bi-check-circle-fill text-success"></i>Mengisi form online di website SIPENA dan mengunggah dokumen pendukung, yaitu:
                                ...
                                <br>- SK Penetapan Pembimbing Skripsi,
